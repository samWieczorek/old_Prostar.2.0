...
golem::fill_desc(
  pkg_name = "Prostar.2.0", # The Name of the package containing the App 
  pkg_title = "PKG_TITLE", # The Title of the package containing the App 
  pkg_description = "Prostar 2.0 provides a GUI interface for DAPAR.", # The Description of the package containing the App 
